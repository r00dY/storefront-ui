...
${<Example code={require("!!raw-loader!../src/packages/Accordion/examples/01-accordion-raw.js")} component={require('../src/packages/Accordion/examples/01-accordion-raw.js').default} />}

### \`Accordion\`

\`Accordion\` makes it quicker to add internal state + header.

${<Example code={require("!!raw-loader!../src/packages/Accordion/examples/02-accordion.js")}
           component={require('../src/packages/Accordion/examples/02-accordion.js').default}/>}

### \`ItemListAccordion\`

Frequently we need to show item list with couple of items hidden and possible to uncollapse.

${<Example code={require("!!raw-loader!../src/packages/ItemListAccordion/examples/01-standard-use.js")} component={require('../src/packages/ItemListAccordion/examples/01-standard-use.js').default} />}
`;
