...
const BoxDynamic = styledBox("section", {
  p: 20,
  bg: p => p.bg || "coral"
});
      ...
      <StoryWrapper
        stories={[
          ...
          },
          {
            ...
            component: <BoxDynamic as="legend">Blah blah blah</BoxDynamic>
          },
          {
            name: "Dynamic non-default",
            component: (
              <BoxDynamic as="legend" bg={"antiquewhite"}>
                Blah blah blah
              </BoxDynamic>
            )
          }
