...
function DropdownMenu({
  ...
  stateless,
  appearance,
  children /* children can't be modified in DropdownMenu */,
  ...appearanceProps
}) {
  return (
    <Index.Consumer>
      {({ DropdownMenu, ListItem, Popup }) => {
        let {
          ...
          body,
          item
        } = getAppearance(appearance, appearanceProps, DropdownMenu);
        ...
        return <PopupComponent {...popup}>{content}</PopupComponent>;
      }}
    </Index.Consumer>
  );
}
