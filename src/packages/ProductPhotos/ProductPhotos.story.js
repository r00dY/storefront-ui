...
function StoryGrid() {
  ...
  return (
    <Index>
      ...
      <p>
        <code>ProductPhotos</code> is responsible for showing product photos and
        managing active state and coordination between thumbnails, arrows
        controllers etc.
      </p>
      <p>
        It might be used in product page, product zoom overlay, product quick
        look overlay etc.
      </p>
        ...
        <GridItem params={{ xs: 12 }}>
          <ProductPhotos
            ...
            imageComponent={(image, isActive, index) => (
              <ImageZoomable images={image} load={true} mode={"natural"} />
            )}
            gutter={5}
          />
        </GridItem>
